...
var appIcon = path.join(__dirname, 'images', 'app.png'); // NOTE: add image to ./image!
var appIconEvent = path.join(__dirname, 'images', 'app_event.png'); // NOTE: add image to ./image!
